...
summarise_MR_fit <- function(fit) {
  ...
  estimates[estimates$parameter == "Tlc", ] ## minimum ambient temperature in thermoneutral zone
  estimates[estimates$parameter == "Tbt", ] ## body temperature at minimal metabolic rate
  estimates[estimates$parameter == "Tt", ] ## temperature at minimal metabolic rate
  estimates[estimates$parameter == "TMR", ] ## minimal metabolic rate in torpor
  estimates
}
